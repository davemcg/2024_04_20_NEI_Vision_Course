...
```{r, include=FALSE}
eiad <- read.csv("https://github.com/davemcg/2024_04_20_NEI_Vision_Course/raw/main/guides/data/eyeIntegration23_meta_2023_09_01.built.csv.gz", header = TRUE)
```
...
ggplot(data = eiad, mapping = aes(x = gdpPercap, y = lifeExp))
```
