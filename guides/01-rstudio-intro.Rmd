...
Welcome to the R portion of the R for Vision Research Skills Course!
...
We will begin with raw data, perform exploratory analyses, and learn how to plot results graphically. This example starts with a dataset from [eyeintegration](https://eyeIntegration.nei.nih.gov) containing bulk RNAseq data from human ocular samples. Can you read the data into R? Can you plot the number of retina samples? Can you calculate the average expression of Rho in RPE and retina?

By the end of these lessons you will be able to make import data, filter and mutate it, and make custom plots.
