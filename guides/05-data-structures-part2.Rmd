...
Let's investigate eiad a bit; the first thing we should always do is check
...
number of rows it has (LOTS), but this is not the case; remember, a data frame
...
When `length` gave us 29, it's because eiad is built out of a list of 29
